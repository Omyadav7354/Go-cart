...
const VendorLoginForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://backend-gocart.onrender.com/vendors/login", formData)
      .then((res) => {
  ...
  const handleSendOtp = (e) => {
    ...
    setMsg("");
    axios
      .post("https://backend-gocart.onrender.com/vendors/forgot", { mobile_number: forgotMobile })
      .then((res) => {
        setOtpSent(true);
  ...
  const handleResetPassword = (e) => {
    ...
    setMsg("");
    axios
      .post("https://backend-gocart.onrender.com/vendors/reset", {
