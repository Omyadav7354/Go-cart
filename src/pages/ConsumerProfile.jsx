...
const ConsumerProfile = () => {
    ...
    const fetchData = async () => {
      try {
        const consumerResponse = await axios.get(
          `https://backend-gocart.onrender.com/consumers/${consumerId}`
        );
        ...
        if (activeTab === "orders") {
          const ordersResponse = await axios.get(
            `https://backend-gocart.onrender.com/orders/consumer/${consumerId}`
          );
  ...
  const handleEditSubmit = (e) => {
    ...
    const consumerId = JSON.parse(localStorage.getItem("consumer_id"));
    axios
      .put(`https://backend-gocart.onrender.com/consumers/${consumerId}`, {
        ...editData,
