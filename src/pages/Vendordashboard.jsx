...
const VendorDashboard = () => {
  ...
  useEffect(() => {
    if (vendorId) {
      axios.get(`https://backend-gocart.onrender.com/vendors/${vendorId}`)
        .then((res) => setVendorData(res.data.data))
        .catch((err) => console.error("Vendor fetch failed:", err));

      axios.get(`https://backend-gocart.onrender.com/products/${vendorId}`)
        .then((res) => setProductList(res.data.data))
        .catch((err) => console.error("Product fetch failed:", err));

      axios.get("https://backend-gocart.onrender.com/orders")
        .then((res) => {
  ...
  const handleSubmitProduct = () => {
    axios.post("https://backend-gocart.onrender.com/products", productDetails)
      .then((res) => {
        alert("Product added!");
  ...
  const handleDeleteProduct = (productId) => {
    axios.delete(`https://backend-gocart.onrender.com/products/${productId}`)
      .then(() => {
  ...
  const updateOrderStatus = (orderId, newStatus) => {
    axios.put(`https://backend-gocart.onrender.com/orders/${orderId}`, { status: newStatus })
      .then(() => {
